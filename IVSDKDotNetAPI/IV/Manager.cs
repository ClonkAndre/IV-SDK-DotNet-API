...
namespace IVSDKDotNetAPI.IV
{
    ...
    public class Manager : APIEndPointBase
    {
        ...
        public Task<Result<ManagerApiPreferences>> GetPreferences()
        {
            ...
            // Send request
            Send(Message.Create(MessageSendMode.Reliable, messageID));
        ...
        public Task<Result<byte>> LoadScript(string scriptFileName)
        {
            ...
            // Send request
            Message msg = Message.Create(MessageSendMode.Reliable, messageID);
        ...
        public Task<Result<bool>> IsScriptRunning(string name)
        {
            ...
            // Send request
            Send(Message.Create(MessageSendMode.Reliable, messageID).AddString(name));
        ...
        /// </summary>
        /// <param name="script">The ID or the Name of the Script that should receive this command.</param>
        ...
        public Task<Result<object>> SendScriptCommand(string script, string command)
        {
            ...
            // Send request
            Send(Message.Create(MessageSendMode.Reliable, messageID).AddString(script).AddString(command));
