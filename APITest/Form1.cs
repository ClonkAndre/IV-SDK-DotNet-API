...
namespace APITest
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                LogMessage("GET_PLAYER_ID succeeded");
                ...
                connection.Game.CallNativeFunction("CONVERT_INT_TO_PLAYERINDEX", id.Result.Value.GetUInt()).ContinueWith(x =>
                {
                    ...
                    LogMessage("CONVERT_INT_TO_PLAYERINDEX succeeded");
                    ...
                    connection.Game.CallNativeFunction("GET_PLAYER_CHAR", playerId, null).ContinueWith(y =>
                    {
                        ...
                        LogMessage("GET_PLAYER_CHAR succeeded");

                        connection.Game.CallNativeFunction("GET_CHAR_COORDINATES", playerPed, null, null, null).ContinueWith(z =>
                        {
                            LogMessage("GET_CHAR_COORDINATES succeeded");
                            ...
                            // - - - Cannot convert from type "object" to type "System.Numerics.Vector3" - - -
